...
<html lang="en">
<head>
	<title>CCMiners Home</title>
	<meta charset="UTF-8">
	<meta name="description" content="CCMiner">
	<meta name="keywords" content="cryptocurrency, z cash">
...
?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 hero-text">
					<h2>Invest in <span>Z Cash</span> <br>Z Cash Trading</h2>
					<h4>Use modern progressive technologies of Z Cash to earn money</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					<h2>What is Z Cash</h2>
					<h5>Z Cash is an innovative payment network and a new kind of money.</h5>
					<p>Z Cash is one of the most important inventions in all of human history. For the first time ever, anyone can send or receive any amount of money with anyone else, anywhere on the planet, conveniently and without restriction. It’s the dawn of a better, more free world.</p>
	...
	<section class="features-section spad gradient-bg">
		<div class="container text-white">
			<div class="section-title text-center">
				<h2>Our Features</h2>
				<p>Z Cash is the simplest way to exchange money at very low cost.</p>
			</div>
			<div class="row">
				<!-- feature -->
				<div class="col-md-6 col-lg-4 feature">
					...
					<div class="feature-content">
						<h4>Mobile Apps</h4>
						<p>Description Descriptio nDescription Description Description Description Description Description Description Description</p>
	...
	<section class="process-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Get Started With Z Cash</h2>
				<p>Start learning about Z Cash with interactive tutorials. It’s fun, easy, and takes only a few minutes! </p>
			</div>
			<div class="row">
		...
		<div class="container text-white">
			<div class="row">
				...
				<div class="col-lg-5 col-md-8 offset-lg-0 offset-md-2">
					<a href="" class="site-btn sb-gradients sbg-line mt-5">Click here</a>
				</div>
				</div>
			</div>
		</div>
	...
	<!-- Footer section -->
	<footer class="footer-section gradient-bg">
		<div class="container">
			<div class="row spad">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved 
				...
				<div class="col-md-6 col-lg-3 footer-widget pl-lg-5 pl-3">
					...
					<div class="social">
						<a href="" class="facebook" style="margin-bottom:10px;"><i class="fa fa-facebook"></i></a>
